<jsp:include page='commons/headerCommon.jsp'>
    <jsp:param name="articleId" value="Portfolio_2"/>
</jsp:include>
...
<div class="container">
	...
	<h1 class="mt-4 mb-3">
		Portfolio 2 <small>Subheading</small>
	</h1>

	<jsp:include page='commons/breadCrumbs.jsp'>
		<jsp:param name="pageName" value="Portfolio 2" />
	</jsp:include>
			...
			<div class="card h-100">
				...
				<div class="card-body">
					...
					<p class="card-text">Lorem ipsum dolor sit amet, consectetur
						...
						nobis numquam, rem expedita, aliquid optio, alias illum eaque. Non
